...
public final class Task<TResult> {
     ...
     */
    public convenience init(_ executor: Executor = .mainThread, closure: @escaping (() throws -> TResult)) {
     ...
     */
    public class func execute(_ executor: Executor = .mainThread, closure: @escaping (() throws -> TResult)) -> Task {
