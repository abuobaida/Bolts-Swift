...
public final class Task<TResult> {
     ...
     */
    public convenience init(_ executor: Executor = .mainThread, closure: @escaping ((Void) throws -> TResult)) {
     ...
     */
    public class func execute(_ executor: Executor = .mainThread, closure: @escaping ((Void) throws -> TResult)) -> Task {
    ...
    /**
     ...
     - returns: A task that will continue with the task returned by the given closure.
     */
    public class func executeWithTask(_ executor: Executor = .mainThread, closure: @escaping (() throws -> Task)) -> Task {
